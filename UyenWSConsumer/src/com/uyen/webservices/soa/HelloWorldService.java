 ...
 * 
 */
@WebServiceClient(name = "HelloWorldService", targetNamespace = "http://soa.webservices.uyen.com/", wsdlLocation = "http://localhost:8080/ws/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDSERVICE_QNAME = new QName("http://soa.webservices.uyen.com/", "HelloWorldService");
    ...
    public HelloWorld getHelloWorldPort() {
        return super.getPort(new QName("http://soa.webservices.uyen.com/", "HelloWorldPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soa.webservices.uyen.com/", "HelloWorldPort"), HelloWorld.class, features);
    }
